...
let powerSchema = new mongoose.Schema({
  name: {type: mongoose.Schema.Types.String, required: REQUIRED_VALIDATION_MESSAGE, unique: [true, 'This food additives already exists.']},
  ...
  Power.find({}).then(powers => {
    ...
    const powersSeed = [
      ...
      },
      {
        ...
        price: 88.30,
        weight: 2.270,
        image: 'https://sportensklad.bg/image/cache/catalog/dobavki-s/22264_pm_mex_amw_500g-500x500.jpg',
        likes: [],
        reviews: []
      },
      {
